...
def main():
		...
		for epoch in range(epochs):
			...
			save_generator_image(generated_img, f"./5IMAGE_WGAN_MNIST_dc/epoch{epoch+1}.png")
		...
		plt.savefig(f"5WGAN_MNIST_emd_epoch_dc.png")
		plt.close()
		...
		plt.savefig(f"5WGAN_MNIST_loss_epoch_dc.png")
		plt.close()
